...
Check the formatting of the code chunk, particularly paying attention to the `fig.alt` argument. Respectively for those issues, make sure there are no linebreaks and that you don't have double quotation marks surrounding a subphrase or word in the `fig.alt` text. 
