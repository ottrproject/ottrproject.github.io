...
The `cow` package is already on the `jhudsl/base_ottr` Docker image  so you do not need to install it if you are using the Docker image or if you are have GitHub Actions do all the rendering for you.
...
Borrowing from a private repository is not supported.
