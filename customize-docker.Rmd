...
If you are new to Docker, you may find it helpful to read this [introduction to Docker](https://ottrproject.org/Adv_Reproducibility_in_Cancer_Informatics/launching-a-docker-image.html).
...
2) Create a new Docker image on your Dockerhub account. Follow these [instructions](https://ottrproject.org/Adv_Reproducibility_in_Cancer_Informatics/launching-a-docker-image.html) if you don't know how to do that.
...
[Read this chapter for instructions on how to modify Docker images](https://ottrproject.org/Adv_Reproducibility_in_Cancer_Informatics/modifying-a-docker-image.html)
...
[Read this chapter for more tips on how to modify Docker images](https://ottrproject.org/Adv_Reproducibility_in_Cancer_Informatics/modifying-a-docker-image.html)
...
For more guidance on how to personalize Docker images, we taking our [Containers for Scientist course](https://ottrproject.org/Containers_for_Scientists/). Or file a GitHub issue on the relevant repository.
